        ...
        <Fragment>
            ...
            <Layout>
                <div className="about-page" style={{padding: "20px"}}>
                    <h1 className="title" style={{paddingBottom: "20px"}}>We're ready to server you better!</h1>
                    <p className="text" style={{padding: "20px 0", lineHeight: "30px", fontSize: "16px"}}>
                        Welcome to JustPantry, A online Grocery Dukkan. We're dedicated
                        ...
                        first started out, his passion for business drove him in
                        action to build JustPantry. So that JustPantry can offer you a
